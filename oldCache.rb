...
module StorageCommands  
  # @@data = self.class.class_variable_get(:@@data) # No encontre forma de poder crearlas globalmente para el modulo
  # @@times = self.class.class_variable_get(:@@times)
  # @@casIds = self.class.class_variable_get(:@@CASIds)
  # @@index = self.class.class_variable_get(:@@index)
